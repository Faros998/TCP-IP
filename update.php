...
{$sqll = " UPDATE `evidence` SET `name` = '$ename', `manufacturer` = '$emanufacturer', `model` = '$emodel', `cpu` = '$ecpu', `ram` = '$eeeram ($eeeeram) GB', `hdd` = '$ehdd', `sn` = '$esn', `win` = '$ewin', `lastuser` = '$elastuser', `date` = '$date' WHERE `ip` = '$ip';";           
...
if ($resulttt === 0 && $t<5){
    ...
    {$sqll = "UPDATE `evidence` SET `name` = '$ehostnameon', `date` = '$date' WHERE `ip` = '$ip';";                         
...
if ($resulttt === 1 ){
    $ip = $row["ip"];
    $sqll = "UPDATE `evidence` SET `comment` = 'Offline',`date` = '$date' WHERE `ip` = '$ip';";                                                                 
